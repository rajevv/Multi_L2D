...
def Hemmer():
	...
	for seed in seeds:
		...
		for i, n in enumerate(experiment_experts):
			confs = read_json_file(get_file_name('confidence', path, experiment_name, n, seed))['test']
			true = read_json_file(get_file_name('true_label', path, experiment_name, n, seed))['test']
			exps = read_json_file(get_file_name('expert_predictions', path, experiment_name, n, seed))['test']

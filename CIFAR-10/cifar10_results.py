...
# ece_ova = np.array([0.13224682, 0.12023479, 0.100782335, 0.095202245, 0.10850768]) * 100
#
# sns.set_context("notebook", font_scale=1.5, rc={"lines.linewidth": 30})
...
ece_ova = np.array([0.08306407, 0.09608422, 0.08810554, 0.092499636, 0.09254267]) * 100
...
plt.ylabel(r'Average ECE $\%$')
plt.xlabel(r'Probability of Experts')
plt.legend()
plt.grid()
plt.tight_layout()

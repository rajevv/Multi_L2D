    ...
    for epoch in range(0, config["epochs"]):
        ...
        if validation_loss < best_validation_loss:
            ...
            save_path = os.path.join(config["ckp_dir"],
                                     config["experiment_name"] + '_' + str(
                                         len(expert_fns)) + '_experts' + '_seed_' + str(seed))
...
def increase_experts(config):
    ...
    expert1 = CIFAR10Expert(class_names, p_in=0.6)
    expert2 = CIFAR10Expert(["Horse", "Deer"], p_in=0.7)
    expert3 = CIFAR10Expert(["Airplane", "Ship"], p_in=0.7)
    expert4 = CIFAR10Expert(animals, p_in=0.7)
    expert5 = CIFAR10Expert(["Cat", "Dog"], p_in=0.8)
    expert6 = CIFAR10Expert(["Bird", "Frog"], p_in=0.7)
    expert7 = CIFAR10Expert(vehicles, p_in=0.7)
    expert8 = CIFAR10Expert(["Automobile", "Truck"], p_in=0.7)
    expert9 = CIFAR10Expert(animals, p_in=0.85)
    expert10 = CIFAR10Expert(vehicles, p_in=0.85)
